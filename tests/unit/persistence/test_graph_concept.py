...
async def test_get_concept(sqlite, cn_db_engine, entities):
    # Defer import until environment is patched
    from py_semantic_taxonomy.adapters.persistence.graph import PostgresKOSGraph
...
async def test_get_concept_not_found(sqlite, cn_db_engine):
    # Defer import until environment is patched
    from py_semantic_taxonomy.adapters.persistence.graph import PostgresKOSGraph
...
async def test_create_concept(sqlite, cn_db_engine, cn, entities):
    # Defer import until environment is patched
    from py_semantic_taxonomy.adapters.persistence.graph import PostgresKOSGraph
...
async def test_create_concept_duplicate(sqlite, cn_db_engine, cn, entities):
    # Defer import until environment is patched
    from py_semantic_taxonomy.adapters.persistence.graph import PostgresKOSGraph
